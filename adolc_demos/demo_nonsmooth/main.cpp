...
// Define the function to be differentiated: f(x) = |x|
...
int main() {
    ...
    int m = 1, n = 1;
    auto xp = new double[n]; xp[0] = 0.;    // Independent vector
    ...
    cout << setw(20) << "AD derivative" << endl;
    cout.precision(8);
    cout.setf(ios::fixed);
    cout << setw(20) << y1[0] << endl;
    cout << endl;
